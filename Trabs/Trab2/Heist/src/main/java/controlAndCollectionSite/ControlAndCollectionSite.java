...
public class ControlAndCollectionSite implements IMasterThief, IOrdinaryThief {
    ...
    private final generalRepository.IControlAndCollectionSite genRep;

    /**
     * Creates a new ControlAndCollectionSite
     * @param genRep - General Repository Identifier of the Control And Collection Interface
     */
    public ControlAndCollectionSite(generalRepository.IControlAndCollectionSite genRep) {
        this.genRep = genRep;
        deliveredCanvas = 0;
        collectedCanvas = 0;
        roomToSteal = -1;
