...
public class MuseumRun {
    ...
    public static void main(String[] args) {
        ...
        SERVER_PORT = confProxy.getServerPorts().get("Museum");
        SERVER_HOST = confProxy.getServerHosts().get("Museum");
        ...
        MuseumServer museumServer = new MuseumServer(genRepProxy);
        ...
        while (true) {   
            ...
            cliProxy = new ServerProxy(schani, museumServer);
            cliProxy.start();
        }
    }
}
